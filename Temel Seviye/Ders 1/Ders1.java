...
public class Ders1 {
	...
	public static void main (String[] args) {
		...
		System.out.println("Kelime uzunluðu "+ stringDeger.length());
	}
	...
	public static void mainString1(String[] args) {
		...
		//bu bir konsola yazýdrma komutudur
	...
	public static void mainVariablesType(String[] args) {
		...
		System.out.println("Float Deðer: "+ floatDeger);
		System.out.println("Double Deðer: "+ doubleDeger);
		
		System.out.println("Char Deðer 1: "+ charDeger1);
		System.out.println("Char Deðer 2: "+ charDeger2);
		
		System.out.println("Boolean Doðru: "+ dogruDeger);
		System.out.println("Boolean Yanlýþ: "+ yanlisDeger);
	}
